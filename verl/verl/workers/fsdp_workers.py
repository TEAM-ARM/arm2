...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        from transformers import AutoConfig, AutoModelForCausalLM, AutoModelForVision2Seq, AutoModel, AutoModelForImageTextToText
    ...
    def generate_sequences(self, prompts: DataProto):
        ...
        # self.rollout.datasets_config = self.datasets_config
        prompts = prompts.to(torch.cuda.current_device())

        # self.rollout.datasets_config = self.datasets_config
        # ray.get(self.rollout.set_attr.remote("datasets_config", self.datasets_config))
