...
def create_colocated_worker_cls(class_dict: dict[str, RayClassWithInitArgs]):
    ...
    class WorkerDict(worker_cls):
        ...
        def set_attr_to_subworker(self, subworker_name, attr_name, value):
            """
            Set an attribute for the specified subworker.
            """
            subworker = self.worker_dict[subworker_name]
            setattr(subworker, attr_name, value)
            return True

        def set_attr_all_subworkers(self, attr_name, value):
            """
            Set the same attribute for all subworkers.
            """
            for subworker in self.worker_dict.values():
                setattr(subworker, attr_name, value)
            return True
